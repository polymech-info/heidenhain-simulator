0  BEGIN PGM 25d-rack-probex MM 
1  BLK FORM 0.1 Z  X-30.047  Y-29.811  Z-25
2  BLK FORM 0.2  X+65.463  Y+30.189  Z+0
3  ;-------------------------------------
4  ;Tools
5  ;  #100 D=6 CR=3 - ZMIN=-18.55 - ZMAX=+55 - probe
6  ;    Heidenhain
7  ;-------------------------------------
8  ;
9  * - Probe WCS2
...
17 TCH PROBE 412 DATUM INSIDE CIRCLE ~
    ...
    Q261=-15.55 ;MEASURING HEIGHT ~
    Q320=+1    ;SET-UP CLEARANCE ~
