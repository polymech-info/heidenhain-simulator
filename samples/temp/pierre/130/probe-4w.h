0  BEGIN PGM probe-4w MM 
1  BLK FORM 0.1 Z  X-85.5  Y-78  Z-30
2  BLK FORM 0.2  X+85.5  Y+78  Z+0
3  ;-------------------------------------
4  ;Tools
5  ;  #100 D=6 CR=3 - ZMIN=-8 - ZMAX=+55 - probe
6  ;    Heidenhain
7  ;-------------------------------------
8  ;
9  * - Probe WCS1
