0  BEGIN PGM probe-120 MM 
1  BLK FORM 0.1 Z  X-60  Y-60  Z+0
2  BLK FORM 0.2  X+60  Y+60  Z+14
3  ;-------------------------------------
4  ;Tools
5  ;  #100 D=6 CR=3 - ZMIN=+7.5 - ZMAX=+69 - probe
6  ;    Heidenhain
7  ;-------------------------------------
8  ;
9  * - Probe WCS1 (2)
...
17 TCH PROBE 413 DATUM OUTSIDE CIRCLE ~
    ...
    Q262=+120  ;NOMINAL DIAMETER ~
    Q325=+0    ;STARTING ANGLE ~
    Q247=+90   ;STEPPING ANGLE ~
    Q261=+10.5 ;MEASURING HEIGHT ~
    Q320=+12   ;SET-UP CLEARANCE ~
    Q260=+19   ;CLEARANCE HEIGHT ~
