0  BEGIN PGM probe_z_coupling_all2 MM 
1  BLK FORM 0.1 Z  X-35  Y-35  Z-40
2  BLK FORM 0.2  X+35  Y+35  Z+0
3  ;-------------------------------------
4  ;Tools
5  ;  #100 D=6 CR=3 - ZMIN=-18 - ZMAX=+55 - probe
6  ;    Stock Haas Probe
7  ;    Renishaw
8  ;    OMP40-2
9  ;-------------------------------------
...
21 L  Z+55 FMAX
22 * - Probe WCS2
23 L  X-28.325  Y+0 R0 FMAX
24 L  Z+55 R0 FMAX
25 TCH PROBE 417 DATUM IN TS AXIS ~
    Q263=-28.325 ;1ST POINT 1ST AXIS ~
    Q264=+0    ;1ST POINT 2ND AXIS ~
    Q294=-1    ;1ST POINT 3RD AXIS ~
...
28 L M140 MB MAX
29 M30
30 END PGM probe_z_coupling_all2 MM 
